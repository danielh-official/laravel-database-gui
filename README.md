...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-database-gui.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-database-gui)
...
echo $laravelDatabaseGui->echoPhrase('Hello, DanielHOfficial!');
```
